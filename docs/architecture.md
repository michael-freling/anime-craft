...
- `ListResumableSessions(limit int) -> []ResumableSession` -- Saved drawings the home screen offers to pick back up, submitted ones included, with when each was started and last updated, and what the most recent graded attempt on it scored.
