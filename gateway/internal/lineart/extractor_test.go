...
// libraryRelPath returns the ONNX Runtime library path for the current OS.
func libraryRelPath() string {
...
func repoRoot(t *testing.T) string {
	...
	// The test runs from gateway/internal/lineart/, so go up three directories.
	dir, err := os.Getwd()
	if err != nil {
